        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              AuthButton(label: widget.submit, onPressed: () {}),
              ...
              const SizedBox(height: 20),
              AuthButton(label: 'Continue with Google', outlined: true, icon: SvgPicture.asset('assets/branding/google_logo.svg', width: 22, height: 22), onPressed: () {}),
              const SizedBox(height: 20),
